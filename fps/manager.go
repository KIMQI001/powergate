...
import (
	...
	"github.com/textileio/fil-tools/fps/auth"
	fa "github.com/textileio/fil-tools/fps/fastapi"
	"github.com/textileio/fil-tools/fps/types"
)
...
var (
	...
	log = logging.Logger("fps-manager")
)
